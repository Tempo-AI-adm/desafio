...
- **alvo (opcional):** um número de vezes no desafio inteiro (ex: 2). No formulário a pessoa escolhe **"Única"** (sem alvo) ou **"Repetir"** (aparece "Quantas vezes essa missão deve se repetir?"; cada toque conta 1 vez feita).
